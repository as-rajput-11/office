...
for check_priority in kl:
    cur.execute("insert into mst_running_train_priority(train_id, detraining_station, priority)VALUES("+str(check_priority[0])+",'"+str(check_priority[3])+"',"+str(check_priority[6])+")")
    conn.commit()
cur.execute("select * from mst_running_train_priority")
