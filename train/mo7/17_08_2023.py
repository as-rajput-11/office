...
for key, delay_time_list in itertools.groupby(sorted_list, lambda x: x[3]):
        ...
        for i in range(re):
            ...
            for i in range(cap):
                print(data5[0],"data52")
                # print(delay_time_list,"data53")
                a = data5[0]
             
                delay_time_list1 =[item for item in delay_time_list if item[0] != a[0]]

                print(delay_time_list1,"check")
