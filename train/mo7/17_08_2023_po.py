    ...
    for key, delay_time_list in itertools.groupby(timingchange, lambda x: x[3]):
            ...
            for i in range(cap):
                if data5[i][1] == delay_time_list[i][1]:
                    print(data5[i][1],delay_time_list[i][1],'sameeeeeeeeeeeeeeeeeeeeeee 1111111111111111')
...
##############################################
    ...
    for key, delay_time_list in itertools.groupby(sorted_list, lambda x: x[3]):
            ...
            for i in range(cap):
                if data5[i][1] == delay_time_list[i][1]:
                    print(data5[i][1],delay_time_list[i][1],'samkkkkkkkkkkkkkkkkkkkkkkkk 333333333')
                    print(data5[i],delay_time_list[i])
                time_dif = data5[i][1]-delay_time_list[i][1]
            ...
            for i in range(re):
                ...
                for i in range(cap):
                    if data5[i][1] == delay_time_list[i][1]:
                        print(data5[i][1],delay_time_list[i][1],'samkkkkkkkkkkkkkkkkkkkkkkkk 44444444444444')
                    time_dif = data5[i][1]-delay_time_list[i][1]
                    delt.append(delay_time_list[i])
                    [data5.remove(j) for j in data5 if j[0] == delay_time_list[i][0]]
                    data5[i] = delay_time_list[i]
